...
exports.getCampground =
  exports.deleteCampground =
  exports.editCampground =
  exports.createCampground =
  exports.getCampgrounds =
    void 0;
const geocoding_1 = __importDefault(
...
exports.getCampgrounds = (0, utils_1.asyncHandler)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const campgrounds = yield campground_1.default.find({});
    res.json(campgrounds);
  })
);
exports.createCampground = (0, utils_1.asyncHandler)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    /*
    ...
    */
    ...
    try {
      ...
      (_a = newCampground.images) === null || _a === void 0
        ? void 0
        : _a.push(img0);
      const img1 = {
      ...
      (_b = newCampground.images) === null || _b === void 0
        ? void 0
        : _b.push(img1);
      const img2 = {
      ...
      (_c = newCampground.images) === null || _c === void 0
        ? void 0
        : _c.push(img2);
      const img3 = {
      ...
      (_d = newCampground.images) === null || _d === void 0
        ? void 0
        : _d.push(img3);
      const img4 = {
      ...
      (_e = newCampground.images) === null || _e === void 0
        ? void 0
        : _e.push(img4);
    } catch (err) {
      next;
...
exports.editCampground = (0, utils_1.asyncHandler)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _f, _g, _h, _j, _k;
    ...
    yield campground_1.default.findByIdAndUpdate(
      _id,
    ...
    try {
      ...
      (_f = campground.images) === null || _f === void 0
        ? void 0
        : _f.push(img0);
      const img1 = {
        url: req.files[1].path,
      ...
      (_g = campground.images) === null || _g === void 0
        ? void 0
        : _g.push(img1);
      const img2 = {
        url: req.files[2].path,
      ...
      (_h = campground.images) === null || _h === void 0
        ? void 0
        : _h.push(img2);
      const img3 = {
        url: req.files[3].path,
      ...
      (_j = campground.images) === null || _j === void 0
        ? void 0
        : _j.push(img3);
      const img4 = {
        url: req.files[4].path,
      ...
      (_k = campground.images) === null || _k === void 0
        ? void 0
        : _k.push(img4);
    } catch (err) {
      next;
...
exports.deleteCampground = (0, utils_1.asyncHandler)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { _id } = req.params;
...
exports.getCampground = (0, utils_1.asyncHandler)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { _id } = req.params;
    const campground = yield campground_1.default
      .findById(_id)
